class P2mirror < Formula
  ...
  def caveats
    "Usage Artifact Mirror : p2mirror -verbose -application org.eclipse.equinox.p2.artifact.repository.mirrorApplication -source <P2-SITE-URL> -destination file:<TARGET>"
  end

  test do
    ENV.java_cache
    cp_r Dir["#{libexec}/*"], testpath
    shell_output("#{testpath}/Contents/MacOS/p2mirror -application org.eclipse.equinox.p2.metadata.repository.mirrorApplication -source https://bndtools.ci.cloudbees.com/job/bndtools.master/lastSuccessfulBuild/artifact/build/generated/p2 -destination file:#{testpath}/out -configuration #{testpath}/work/config", 0)
